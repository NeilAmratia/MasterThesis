/****************************************************************************
** Meta object code from reading C++ file 'MessageModel.hpp'
**
...
#error "The header file 'MessageModel.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 28, 7) // "message"
    ...
    "MessageModel\0appendMessage\0\0message"
};
...
void MessageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->appendMessage((*reinterpret_cast< const QVariantMap(*)>(_a[1]))); break;
        default: ;
        }
    }
}
